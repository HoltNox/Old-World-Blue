...
/obj/machinery/computer/atmoscontrol/emag_act(var/remaining_carges, var/mob/user)
	if(!emagged)
		user.visible_message(SPAN_WARN("\The [user] does something \the [src], causing the screen to flash!"),\
			SPAN_WARN("You cause the screen to flash as you gain full control."),\
