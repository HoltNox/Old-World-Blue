...
/obj/item/device/soulstone/attack(mob/living/carbon/human/M as mob, mob/user as mob)
	...
	if(jobban_isbanned(M, "cultist"))
		user << SPAN_WARN("This person's soul is too corrupt and cannot be captured!")
		return..()

	if(M.has_brain_worms()) //Borer stuff - RR
		user << SPAN_WARN("This being is corrupted by an alien intelligence and cannot be soul trapped.")
		return..()
