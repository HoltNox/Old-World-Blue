...
/mob/living/carbon/human/proc/gut()
	...
	visible_message(SPAN_WARN("<b>\The [src]</b> rips viciously at \the [G.affecting]'s body with its claws!"))
...
/mob/living/carbon/human/proc/diona_split_nymph()
	...
	visible_message(SPAN_WARN("\The [src] quivers slightly, then splits apart with a wet slithering noise."))
