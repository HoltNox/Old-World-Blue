	...
	while(Victim && !invalidFeedTarget(M) && stat != 2)
		...
		if(Adjacent(M))
			...
			if(istype(M, /mob/living/carbon))
				...
				src << SPAN_WARN("[pick("This subject is incompatable", "This subject does not have a life energy", "This subject is empty", "I am not satisified", "I can not feed from this subject", "I do not feel nourished", "This subject is not food")]...")
				Feedstop()
				break
