...
/mob/living/carbon/proc/escape_handcuffs()
	...
	visible_message(
		...
		SPAN_WARN("You attempt to remove \the [HC]. (This will take around [displaytime] minutes and you need to stand still)")
		)
...
/mob/living/carbon/proc/break_handcuffs()
	visible_message(
		...
		SPAN_WARN("You attempt to break your [handcuffed.name]. (This will take around 5 seconds and you need to stand still)")
		)
	...
	if(do_after(src, 50))
		...
		visible_message(
			...
			SPAN_WARN("You successfully break your [handcuffed.name].")
			)
...
/mob/living/carbon/proc/break_legcuffs()
	src << SPAN_WARN("You attempt to break your legcuffs. (This will take around 5 seconds and you need to stand still)")
	...
	if(do_after(src, 50))
		...
		visible_message(
			...
			SPAN_WARN("You successfully break your legcuffs.")
			)
...
/mob/living/carbon/escape_buckle()
	...
	if(!restrained())
		...
		visible_message(
			...
			SPAN_WARN("You attempt to unbuckle yourself. (This will take around 2 minutes and you need to stand still)")
			)
